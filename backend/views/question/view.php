                    ...
                    <tbody>    
                            <?php foreach ($answers as $answer) : ?>
                                <tr>
                                    ...
                                    <td>
                                        <?=Html::a('Delete', [ '/question/delete-answer','qa_id' => $answer->qa_id,'q_id' => $question->q_id ], [ 'class' => 'btn btn-danger','data' => [ 'confirm' => 'Are you sure you want to delete this item?','method' => 'post' ] ])?>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                        </tbody>
